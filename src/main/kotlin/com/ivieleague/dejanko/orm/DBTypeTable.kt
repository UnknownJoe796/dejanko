...
private val <K: Any, V> KProperty1<K, V>.dbColumn: DBTypeTable.Column<K, V> get() = columnCache[this] as DBTypeTable.Column<K, V>
...
class DBTypeTable<T: Any>(val type: KClass<T>): DBTable {
    ...
    override val sourceClass: KClass<*> get() = type

    val name: String get() = "${appName}_$modelName"
    ...
    @Suppress("UNCHECKED_CAST")
    override fun <T> columnForProperty(property: KProperty1<*, T>): DBColumn<T>? = columns.find { it.sourceProperty == property } as? DBColumn<T>
}